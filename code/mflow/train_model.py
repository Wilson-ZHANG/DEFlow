...
def get_parser():
    ...
    parser.add_argument('--data_name', type=str, default='qm9', choices=['qm9', 'zinc250k','zinc1k','moses','moses1k','moses17k','polymers117','nucle'], help='dataset name')
...
def train():
    ...
    if args.data_name == 'qm9':
    ...
    elif args.data_name == 'nucle':
        from data import transform_nucle
        data_file = 'nucle_relgcn_kekulized_ggnp.npz'
        transform_fn = transform_nucle.transform_fn_nucle
        atomic_num_list = transform_nucle.nucle_atomic_num_list  # [6, 7, 8, 9, 15, 16, 17, 35, 53, 0]
        ...
        valid_idx = transform_nucle.get_val_ids()
    ...
    elif args.data_name == 'zinc1k':
        from data import transform_zinc1k
        data_file = 'zinc1k_relgcn_kekulized_ggnp.npz'
        transform_fn = transform_zinc1k.transform_fn_zinc1k
        atomic_num_list = transform_zinc1k.zinc1_atomic_num_list  # [6, 7, 8, 9, 15, 16, 17, 35, 53, 0]
        # mlp_channels = [1024, 512]
        # gnn_channels = {'gcn': [16, 128], 'hidden': [256, 64]}
        b_n_type = 4
        b_n_squeeze = 19   # 2
        a_n_node = 38
        a_n_type = len(atomic_num_list)  # 10
        valid_idx = transform_zinc1k.get_val_ids()
        ...
        atomic_num_list = transform_moses.mose_atomic_num_list  # [6, 7, 8, 9, 15, 16, 17, 35, 53, 0]
        # mlp_channels = [1024, 512]
        # gnn_channels = {'gcn': [16, 128], 'hidden': [256, 64]}
        b_n_type = 4
        b_n_squeeze = 19   # 2
    ...
    elif args.data_name == 'moses17k':
        from data import transform_moses17k
        data_file = 'moses17k_relgcn_kekulized_ggnp.npz'
        transform_fn = transform_moses17k.transform_fn_moses17k
        atomic_num_list = transform_moses17k.moses17_atomic_num_list  # [6, 7, 8, 9, 15, 16, 17, 35, 53, 0]
        # mlp_channels = [1024, 512]
        # gnn_channels = {'gcn': [16, 128], 'hidden': [256, 64]}
        b_n_type = 4
        b_n_squeeze = 19   # 2
        a_n_node = 38
        a_n_type = len(atomic_num_list)  # 10
        valid_idx = transform_moses17k.get_val_ids()
    elif args.data_name == 'polymers117':
        from data import transform_polymers117
        data_file = 'polymers117_relgcn_kekulized_ggnp.npz'
        transform_fn = transform_polymers117.transform_fn_polymers117
        atomic_num_list = transform_polymers117.polymers_atomic_num_list  # [6, 7, 8, 9, 15, 16, 17, 35, 53, 0]
        # mlp_channels = [1024, 512]
        # gnn_channels = {'gcn': [16, 128], 'hidden': [256, 64]}
        b_n_type = 4
        b_n_squeeze = 44   # 2
        a_n_node = 87
        a_n_type = len(atomic_num_list)  # 10
        valid_idx = transform_polymers117.get_val_ids()
    elif args.data_name == 'moses1k':
        from data import transform_moses1k
        data_file = 'moses1k_relgcn_kekulized_ggnp.npz'
        transform_fn = transform_moses1k.transform_fn_moses1k
        atomic_num_list = transform_moses1k.moses1_atomic_num_list  # [6, 7, 8, 9, 15, 16, 17, 35, 53, 0]
        # mlp_channels = [1024, 512]
        # gnn_channels = {'gcn': [16, 128], 'hidden': [256, 64]}
        b_n_type = 4
        b_n_squeeze = 19   # 2
        a_n_node = 38
        a_n_type = len(atomic_num_list)  # 10
        valid_idx = transform_moses1k.get_val_ids()
