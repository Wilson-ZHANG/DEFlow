...
from data import transform_qm9, transform_zinc250k, transform_nucle,transform_polymers117, transform_moses,transform_moses1k,transform_moses17k
from data.transform_zinc250k import zinc250_atomic_num_list, transform_fn_zinc250k
from data.transform_moses import mose_atomic_num_list, transform_fn_moses
from data.transform_nucle import nucle_atomic_num_list, transform_fn_nucle
from data.transform_polymers117 import polymers_atomic_num_list, transform_fn_polymers117
from data.transform_moses1k import moses1_atomic_num_list, transform_fn_moses1k
from data.transform_moses17k import moses17_atomic_num_list, transform_fn_moses17k
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_name', type=str, default='qm9', choices=['qm9', 'zinc250k','nucle','polymers117','moses','moses1k','moses17k'], help='dataset name')
    ...
    if args.data_name == 'qm9':
        ...
        atomic_num_list = polymers_atomic_num_list
                        # transform_fn = transform_qm9.transform_fn
